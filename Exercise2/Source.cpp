...
int main(void) {
    ...
    // This tests negative numbers and duplicate number for sorting
    int test_Custom[] = { 3, 3, 2, 0, -1, 0};
    sort(test_Custom, 6);
    printArray(test_Custom, 6);

    // This tests an empty sort
    int test_Custom2[] = {};
    sort(test_Custom2, 0);
    printArray(test_Custom2, 0);
}
